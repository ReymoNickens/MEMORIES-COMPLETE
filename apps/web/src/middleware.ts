 ...
 */
const PROTECTED_PREFIXES = ['/dashboard', '/organiser', '/bar', '/kitchen', '/floor', '/waiter', '/reissue', '/staff/claim', '/staff/home', '/admin', '/front-office']
...
export const config = {
  matcher: [
    ...
    '/staff/home/:path*', '/admin/:path*', '/front-office/:path*',
  ],
}
